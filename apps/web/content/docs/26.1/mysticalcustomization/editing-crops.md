...
You can change the crafting ingredient used to craft a crop's seed. This can be either an item or tag and uses the same syntax as a crafting recipe.
...
```json
{
  "respects_effective_farmland": false
}
```
