...
Place the required items in the input slots to apply a [Charm](../items/charms.md) to a [Supremium Tool](../items/essence-tools.md) or [Supremium Armor](../items/essence-armor.md).
