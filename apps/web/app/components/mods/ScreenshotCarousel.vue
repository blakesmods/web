<template>
  <div id="screenshots" class="text-center scroll-mt-24">
    ...
    <Carousel :value="screenshots" :num-visible="1" :num-scroll="1">
      <template #item="{ data }">
        <div class="relative flex flex-col">
          ...
          />
          <div
            class="absolute inset-x-0 bottom-0 space-y-2 py-4 text-center bg-neutral-300/50 dark:bg-neutral-700/50 backdrop-blur-[12px]"
          >
            <h3>{{ data.title }}</h3>
