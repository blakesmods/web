<template>
  <div class="container my-4 pt-16 space-y-4">
    <h1 class="text-center my-8">Privacy Policy</h1>
    ...
    <ul>
      <li>
        ...
        and analyze the use of our Service, to show advertisements to You to
        help support and maintain Our Service, to contact You.
      </li>
      <li>
        <strong>For business transfers:</strong>
