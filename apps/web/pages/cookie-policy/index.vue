  ...
  <div class="container my-4 pt-16 space-y-4">
    ...
    <ul>
      ...
      <li>
        ...
        refers to Blake's Mods, accessible from
        <a
          href="https://blakesmods.com"
          rel="external nofollow noopener"
          target="_blank"
        >
          https://blakesmods.com
        </a>
      </li>
      <li>
        <strong>You</strong>
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          ...
          advertisements on and through the Website, and so on. These Cookies
          may be used when You share information using a social media networking
          website such as Facebook, Instagram, Twitter or Google+.
        </p>
      </li>
    </ul>
    ...
    <ul>
      <li>By email: hi@blakesmods.com</li>
    </ul>
  </div>
</template>
